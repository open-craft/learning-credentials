...
from .api import generate_credential_for_user, get_eligible_users_by_credential_type, get_user_credentials_by_type
...
class CredentialsXBlock(StudioEditableXBlockMixin, XBlock):
    ...
    @XBlock.json_handler
    def generate_credential(self, data, suffix='') -> dict[str, str]:
        """
